...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Welcome ! Lawyer</a>
            </div>
    ...
    <div class="container">
        <header class="row" style="border: 1px solid black; margin: 30px; padding: 50px;">
            <div class="col-sm-6" >
                <a href="epay.php" style="font-size: 3em">Make a Bill</a>
            </div>

             <div class="col-sm-6" >
                <a href="lawyercasenotification.php" style="font-size: 3em">Check Notification</a>
            </div>
