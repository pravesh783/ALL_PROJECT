...
if(isset($_POST['signup']))
{
	...
	$msg=mysqli_query($con,"insert into lawyer(fname,lname,email,password,contactno, yourcaseid) values('$fname','$lname','$email','$enc_password','$contact', '$yourcaseid')");
if($msg)
{
...
$ret= mysqli_query($con,"SELECT * FROM lawyer WHERE email='$useremail' and password='$dec_password'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="lawyerwelcome.php";
